...
class AppUserProfile {
  const AppUserProfile({
    ...
    this.shareWithOptician = false,
    this.shareWithCompany = false,
    this.createdAt,
    this.updatedAt,
    this.gdprConsentAt,
  ...
  factory AppUserProfile.fromMap(Map<String, dynamic> map) {
    return AppUserProfile(
      ...
      consentActive: (map['consentActive'] ?? true) as bool,
      shareWithOptician: (map['shareWithOptician'] ?? false) as bool,
      shareWithCompany: (map['shareWithCompany'] ?? false) as bool,
      createdAt: _asDateTime(map['createdAt']),
      updatedAt: _asDateTime(map['updatedAt']),
      gdprConsentAt: _asDateTime(map['gdprConsentAt']),
      consentWithdrawnAt: _asDateTime(map['consentWithdrawnAt']),
    );
  }
